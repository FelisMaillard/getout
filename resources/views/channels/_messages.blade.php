<!-- Voici la version modifiée de resources/views/channels/_messages.blade.php -->
...
@media (min-width: 768px) {
    /* Ajustements pour la version PC uniquement */
    .flex-1.min-h-0.relative {
        max-height: calc(100vh - 160px); /* Ajuste la hauteur pour éviter le débordement */
    }
