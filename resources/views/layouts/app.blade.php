...
<body class="bg-black text-white antialiased h-full">
    <div class="min-h-screen flex">
                    ...
                    <ul class="px-2 space-y-2">
                        ...
                        <li>
                            <a href="{{ route('servers.index') }}" class="flex items-center p-2 hover:bg-gray-800 rounded-lg transition-colors duration-200">
                                ...
                                <span class="ml-4 text-white w-0 group-hover/sidebar:w-auto overflow-hidden whitespace-nowrap transition-all duration-300">Serveurs</span>
                            </a>
                        </li>
        ...
        <!-- Navigation mobile -->
        <div class="md:hidden fixed top-0 left-0 right-0 z-50 bg-black border-t border-gray-800">
            <div class="flex justify-between items-center p-2 px-6">
            <a href="{{ route('home') }}" class="flex items-center p-2 text-white transition-colors duration-200">
                <img src="{{ asset('images/logo.png') }}" alt="GetOut" class="w-6 h-6">
                <span class="ml-0 mt-2 font-bold">etOut</span>
            </a>
        ...
        <nav class="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-black border-t border-gray-800 channel-navbar">
            <div class="flex justify-around items-center p-2">
                ...
                <a href="{{ route('search.index') }}" class="p-2 text-white hover:text-purple-500 transition-colors duration-200">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                    </svg>
                </a>
                ...
                <a href="{{ route('notifications.index') }}" class="relative flex items-center rounded-lg">
                    <div class="w-6 flex justify-center relative">
                        <svg class="w-6 h-6 text-white hover:text-purple-500 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path>
                        </svg>
                        @if($pendingRequestsCount > 0)
        ...
        <!-- Main Content -->
        <main class="flex-1 ml-0 md:ml-16 pb-16 md:pb-0">
